...
//        Node mover = start;
//        if(j<0){
//            while (mover.getCol() != j && mover.getPrev() != mover) {
//                mover = mover.getPrev();
//            }
//        }else{
//            while (mover.getCol() != j && mover.getNext() != mover) {
//                mover = mover.getNext();
//            }
//        }
//        if(i<0){
//            do {
//                mover = mover.getUp();
//            } while (mover.getRow() != i && mover.getRow() != 0 && mover.getUp() != mover);
//        }else{
//             do {
//                mover = mover.getDown();
//            } while (mover.getRow() != i && mover.getRow() != 0 && mover.getDown() != mover);
//        }
//
//        if (mover.getRow() == i && mover.getCol() == j) {
//            return  mover;
